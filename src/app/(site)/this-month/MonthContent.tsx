        ...
        <div className="flex-1 flex flex-col-reverse lg:flex-row items-stretch min-h-0">
          <div className="max-h-screen flex-1 p-6 flex flex-col overflow-auto">
            <div className="relative overflow-hidden bg-white rounded-lg border border-gray-200 shadow-sm p-3 pr-1 flex flex-col h-full ">
              <SlideInDrawer direction="right" width="w-3/4" layer = "z-10" isOpen={isExpenseViewOpen} onClose={() => {
                ...
                <div className="flex flex-col">
                  ...
                  <h3>{focusedExpense?.month} {focusedExpense?.day}, {focusedExpense?.year}</h3>
                </div>
              </SlideInDrawer>
              <SlideInDrawer direction = "bottom" height = "h-3/4" layer = "z-20" isOpen={addOrUpdateExpense} onClose={() => setAddOrUpdateExpense(false)}>
