...
const tableStyles = StyleSheet.create({
  ...
  headerRow: { flexDirection: 'row', borderBottomWidth: 1, borderColor: '#ccc', backgroundColor: '#f0f0f0' },
  row: { flexDirection: 'row', borderBottomWidth: 0.5, borderColor: '#eee' },
  cell: { flex: 1, padding: 4, fontSize: 10 },
  headerCell: { flex: 1, padding: 4, fontSize: 12, fontWeight: 'bold' as const },
  amountCell: { flex: 1, padding: 4, fontSize: 10, textAlign: 'right' as const },
  footerRow: { flexDirection: 'row', borderTopWidth: 1, borderColor: '#ccc', marginTop: 4 },
  footerLabel: { flex: 3, padding: 4, fontSize: 12, fontWeight: 'bold' as const, textAlign: 'right' as const },
  footerValue: { flex: 1, padding: 4, fontSize: 12, fontWeight: 'bold' as const, textAlign: 'right' as const },
});

// PDF table component
export const ExpenseSheetPDF: React.FC<{ expenses: Expense[] }> = ({ expenses }) => {
