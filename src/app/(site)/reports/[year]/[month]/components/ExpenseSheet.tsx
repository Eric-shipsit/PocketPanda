  ...
  return (
    ...
    <table className="min-w-full divide-y divide-gray-200">
      <thead className="bg-gray-50">
        <tr>
          <th className="px-4 py-2 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Day</th>
          ...
          <th className="px-4 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">Amount</th>
        </tr>
      </thead>
      <tbody className="bg-white divide-y divide-gray-200">
        {expenses.map((exp) => (
          <tr key={exp.id}>
            ...
            <td className="px-4 py-2 whitespace-nowrap text-right">${exp.amount.toFixed(2)}</td>
          </tr>
        ))}
      </tbody>
      ...
      <tfoot className="bg-gray-50">
          <tr>
            ...
            <td className="px-4 py-2 whitespace-nowrap text-right font-semibold">${total.toFixed(2)}</td>
          </tr>
        </tfoot>
    </table>
  </div>
