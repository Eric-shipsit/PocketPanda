...
export default function TheMonthPage() {
  ...
  // Right side toggle
  const [rightScreenStatus, setRightScreenStatus] = useState<RightScreenStatus>('GRAPH');
  // Refresh whenever Expenses are being added/deleted/updated
  const [refreshKey, setRefreshKey] = useState(0);
  const [updateExpense, setUpdateExpense] = useState<Expense | undefined>(undefined);
  ...
  return (
    ...
    <div className="w-full flex flex-col md:flex-row">
      ...
      <div className="w-full md:w-1/2 md:h-screen min-h-[700px] bg-blue-100 p-6 overflow-y-auto flex flex-col">
